...
if(cp=='game=stickfigurebadminton2'){
	console.log("Loading Stick Figure Badminton 2")
...
if(cp=='game=stickfigurebadminton3'){
	console.log("Loading Stick Figure Badminton 3")
...
if(cp=='game=raze3'){
	...
	document.getElementById('description').innerHTML = "<p><b>This game is made by Game dev name.</b> Raze 3 is the last game in the series so it isn't so great(in my opinion).</p>"
	document.getElementById('title').innerHTML = '<h1>Raze 3</h1>'
	var runcorrect = true
}
if(cp=='game=strikeforceheroesnotdoppler'){
	console.log("Loading Strike Force Heroes(NotDoppler)")
...
if(cp=='game=zombotron'){
	console.log("Loading Zombotron")
	document.getElementById('gameplayer').innerHTML = '<object width="800" height="600" data="games/swf/zombotron-12000.swf"></object>'
	document.getElementById('description').innerHTML = "<p><b>This game is made by Game dev name.</b> Don't know this game.</p>"
...
if(cp=='game=plazmaburst2'){
  console.log("Loading Plazma Burst 2")
...
if(cp=='game=hauntthehouse'){
  console.log("Loading Haunt The House")
...
if(cp=='game=template'){
  ...
  var runcorrect = true
	...
	if(runcorrect==false){
		...
		document.getElementById('description').innerHTML = '<p>If it wasnt you tampering with the url then please report the error: https://github.com/kres0345/FrostBurn-Games/issues</p>'
	}
}